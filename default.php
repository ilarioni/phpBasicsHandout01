...
?>
    ...
    you can give a class an alias - same way as we saw in namespace alis example:
    ...
    However, if the input field is not empty, do the following:
        ...
        And the str variable holds the content of the input fields
